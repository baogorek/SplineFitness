# Strength Tracker (Spline Fitness)
...
- If the user reports something isn't showing up on production, first check if the relevant files have been committed and pushed
